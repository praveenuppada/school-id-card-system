          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full px-8 py-4 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white font-semibold rounded-xl shadow-lg hover:from-yellow-500 hover:to-yellow-600 transition-all duration-200 transform hover:scale-105"
              >
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-green-500 text-white font-semibold rounded-xl shadow-lg hover:bg-green-600 transition-all duration-200 transform hover:scale-105"
              >
